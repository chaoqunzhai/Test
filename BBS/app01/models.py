...
class UserProifle(models.Model):
    user = models.OneToOneField(User,null=True)     #一一对应的，一个用户只能对应一个django用户！ 不能一对多
...
class Comment(models.Model):
    ...
    p_node = models.ForeignKey("Comment",null=True,blank=True,related_name="my_child_comments")       #blank =True 就是允许通过django amin的认证，可以把这个字段设置为空
