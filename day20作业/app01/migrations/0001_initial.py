# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-24 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_child_comments', to='app01.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
        ...
        migrations.AddField(
            model_name='like',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.UserProifle'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
